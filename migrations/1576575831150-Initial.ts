...
export class Initial1576575831150 implements MigrationInterface {
    name = 'Initial1576575831150'

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TYPE "token" AS ENUM('ETH')`, undefined);
        await queryRunner.query(`CREATE TABLE "wallet" ("token" "token" NOT NULL, "address" text NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_bffe4b5de2ad14a14ae21edd7fc" PRIMARY KEY ("token", "userId"))`, undefined);
        await queryRunner.query(`CREATE TABLE "user" ("id" integer NOT NULL, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "group" ("id" integer NOT NULL, CONSTRAINT "PK_256aa0fda9b1de1a73ee0b7106b" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "group_member" ("userId" integer NOT NULL, "groupId" integer NOT NULL, CONSTRAINT "PK_0b4af14c22502d5f24bf2a89bd2" PRIMARY KEY ("userId", "groupId"))`, undefined);
